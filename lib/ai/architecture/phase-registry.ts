...
export const AI_PHASE_REGISTRY: readonly AIPhaseRegistryEntry[] = Object.freeze([
  ...
  phase({
    ...
    evidence: [
      { kind: 'code', reference: 'lib/agents/coordinator/execution-state.ts' },
      { kind: 'code', reference: 'lib/agents/coordinator/coordinator.ts' },
      { kind: 'code', reference: 'lib/agents/coordinator/live-handoff.ts' },
      { kind: 'code', reference: 'lib/agents/coordinator/governed-pipeline.ts' },
      { kind: 'test', reference: 'lib/agents/coordinator/coordinator.test.ts' },
      { kind: 'test', reference: 'lib/agents/coordinator/live-handoff.test.ts' },
      { kind: 'test', reference: 'lib/agents/coordinator/governed-pipeline.test.ts' },
  ...
  phase({
    ...
    evidence: [
      ...
      {
        kind: 'test',
        reference: 'lib/agents/coordinator/production-governed-runtime.test.ts'
      },
